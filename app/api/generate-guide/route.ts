...
3. 구체적 수치(개수 제한, 최솟값, 최댓값, 기간, 금액 등)는 화면별 설명과 스펙/정책 자료 **모두**에서 확인합니다.
   ...
   - 수치는 자료에 적힌 숫자 그대로 씁니다. "최대 5개"라고 쓰여 있으면 "최대 5개"라고 씁니다. "제한이 있다", "설정 가능하다"처럼 요약하거나 바꾸지 않습니다.
   - 자료 어디에도 수치가 없으면 해당 항목을 본문에 작성하되 "(구체적 수치 확인 필요)"를 덧붙이고, "검수 필요 항목" 표에도 함께 기록합니다. 항목 자체를 삭제하지 않습니다.
