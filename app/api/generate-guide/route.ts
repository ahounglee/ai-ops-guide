...
- 단편 메모 → 완성된 행동 지침: "배너 클릭 시 이동" → "배너를 클릭하면 설정된 랜딩 URL로 이동합니다."
- 행동 주체를 항상 명시: "클릭 시" → "운영자가 클릭하면" / "사용자가 클릭하면"
- 조건 명확화: "로그인 시" → "사용자가 로그인한 상태일 때"
...
- 이 기능을 통해 운영자가 무엇을 할 수 있는지 서술합니다.

## 생성 / 등록 방법
- 어드민에서 이 기능을 생성하거나 등록하는 절차를 단계별로 설명합니다.
- 각 단계에서 운영자가 직접 입력하거나 선택해야 하는 항목을 명확히 기술합니다.

## 관리 방법
- 수정, 삭제, 상태 변경 등 생성 이후의 관리 방법을 설명합니다.

## 화면별 운영 가이드
- 각 화면에 대해 운영자가 확인하고 조작해야 할 내용을 구체적으로 작성합니다.
